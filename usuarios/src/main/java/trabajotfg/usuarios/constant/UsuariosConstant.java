package trabajotfg.usuarios.constant;

public class UsuariosConstant {

    // Add default constructor
    public UsuariosConstant() {
        // Default constructor logic goes here
    }
    ...
    public static final String HTTP_STATUS_CREATED_MESSAGE = "Usuario creado correctamente";
