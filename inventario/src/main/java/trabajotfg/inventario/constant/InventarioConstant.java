package trabajotfg.inventario.constant;
...
public class InventarioConstant {
    ...
    public static final String HTTP_STATUS_CHANGE= "Estado modificado correctamente";
    ...
    public static final String HTTP_STATUS_CREATED_MESSAGE = "Insertado correctamente";
